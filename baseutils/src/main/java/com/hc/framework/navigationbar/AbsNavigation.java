package com.hc.framework.navigationbar;
...
import static com.hc.framework.log.LogUtilPrinter.TAG;
...
public abstract class AbsNavigation<P extends AbsNavigation.Builder.Params> implements INavigation{
     ...
     * 设置左侧返回布局
     */
    public void setLeftText(int viewId ,int viewGroupId,String text){
        TextView tv = findViewById(viewId);
        LinearLayout ll = findViewById(viewGroupId);
        if(TextUtils.isEmpty(text)){
            ll.setVisibility(View.GONE);
            Log.i(TAG, "setLeftText: ty(View.GONE); ");
        }else {
            ll.setVisibility(View.VISIBLE);
            Log.i(TAG, "setLeftText:   ll.setVisibility(View.VISIBLE);");
            tv.setText(text);
        }
